  ...
  return (
    <div className="flex flex-col xl:flex-row gap-6 items-start animate-fadeIn">
      ...
      <div className="w-full xl:w-1/3 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleSalvar} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={salvando}
            className="w-full bg-seduc-primary text-white font-bold py-2.5 rounded-lg hover:bg-white hover:text-seduc-primary border border-transparent hover:border-seduc-primary transition shadow-lg shadow-seduc-primary/20 flex justify-center gap-2 items-center mt-4"
          >
      ...
      <div className="w-full xl:w-2/3">
        <h1 className="text-2xl font-bold text-seduc-primary mb-6">Catálogo de Disciplinas</h1>
              ...
              <div key={disc.id} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex justify-between items-center group hover:shadow-md transition">
                <div>
                  <h3 className="font-bold text-gray-800 flex items-center gap-2">
                    <Bookmark size={16} className="text-seduc-primary" />
                    {disc.nome}
                  </h3>
