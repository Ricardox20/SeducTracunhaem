            ...
            {[
                ...
                <div key={s.num} className="flex items-center">
                    <div className={`flex flex-col items-center relative z-10 ${step >= s.num ? 'text-seduc-primary' : 'text-gray-300'}`}>
                        <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-bold border-2 transition-all duration-300 ${step >= s.num ? 'bg-seduc-secondary border-seduc-secondary text-seduc-primary' : 'bg-white border-gray-200'
                            }`}>
                    ...
                    {index < 3 && <div className={`w-8 sm:w-12 h-1 mx-1 sm:mx-2 -mt-4 sm:-mt-6 transition-all duration-500 ${step > s.num ? 'bg-seduc-secondary' : 'bg-gray-200'}`} />}
                </div>
            ))}
        </div>
    );
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="animate-fadeIn">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm">
                            ...
                            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-200 relative group">
                                <button type="button" onClick={() => setStep(1)} className="absolute top-2 right-2 p-1 text-gray-400 hover:text-seduc-primary hover:bg-gray-200 rounded transition" title="Editar Pessoal">
                            ...
                            {/* Bloco 2: Documentos */}
                            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-200 relative group">
                                <button type="button" onClick={() => setStep(2)} className="absolute top-2 right-2 p-1 text-gray-400 hover:text-seduc-primary hover:bg-gray-200 rounded transition" title="Editar Documentos">
                                    <Edit2 size={14} className="sm:size-4" />
                                </button>
                            ...
                            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-200 relative group sm:col-span-2">
                                <button type="button" onClick={() => setStep(3)} className="absolute top-2 right-2 p-1 text-gray-400 hover:text-seduc-primary hover:bg-gray-200 rounded transition" title="Editar Endereço">
                                    <Edit2 size={14} className="sm:size-4" />
                                </button>
                ...
                {step < 4 && (
                    <div className="flex flex-col sm:flex-row justify-between mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-100 gap-3 sm:gap-4">
                        ...
                        <button type="button" onClick={handleNextStep} className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg bg-seduc-primary text-white hover:bg-white hover:text-seduc-primary border border-transparent hover:border-seduc-primary shadow-lg w-full sm:w-auto text-sm sm:text-base">
                ...
                {step === 4 && (
                    <div className="flex flex-col sm:flex-row justify-between mt-6 sm:mt-8 gap-3 sm:gap-4">
                        ...
                        <button type="submit" disabled={saving} className="flex items-center justify-center gap-2 px-6 sm:px-8 py-2 sm:py-3 rounded-lg bg-seduc-secondary text-seduc-primary font-bold hover:bg-gray-100 shadow-lg disabled:opacity-50 w-full sm:w-auto text-sm sm:text-base border border-seduc-primary">
