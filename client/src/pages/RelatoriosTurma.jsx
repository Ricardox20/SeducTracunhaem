        ...
        <div className="p-6 max-w-7xl mx-auto animate-fadeIn pb-20">
            ...
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <BarChart3 className="text-seduc-primary" />
                    ...
                    <div className="w-full md:w-1/3">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full p-3 pl-10 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-seduc-primary appearance-none"
                            >
                    ...
                    <div className="w-full md:w-1/3">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full p-3 pl-10 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-seduc-primary appearance-none disabled:opacity-50"
                            >
                                <option value="">
                    ...
                    <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-scaleIn">
                        <div className="bg-seduc-primary p-4 flex justify-between items-center text-white">
                            <h3 className="font-bold text-lg flex items-center gap-2">
                                <User size={20} className="text-seduc-secondary" /> {alunoSelecionado.nome}
                            </h3>
                                ...
                                <div className="space-y-2">
                                    {historicoAluno.map((reg, idx) => (
                                        <div key={idx} className="flex justify-between items-center p-3 bg-gray-50 rounded border border-gray-100 text-sm">
                                            ...
                                            <span className={`px-2 py-1 rounded text-xs font-bold ${reg.status === 'Presente' ? 'bg-green-100 text-green-700' :
